...
public class CAPTCHAActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        mPgone_register_title_image = (ImageView) findViewById(R.id.pgone_register_title_image);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_resend_captcha:
                new Thread(new CAPTCHAActivity.MyCountDownTimer()).start();
                sendCAPTCHA(phone);
            ...
            case R.id.btn_login_captcha:
                submit();
                break;
            case R.id.pgone_register_title_image:
                finish();
        }
    }
