...
import com.bawei.taynews_demo.adapter.OtherAdapter;
import com.bawei.taynews_demo.utils.MyGridView;
...
public class PinDaoguanli extends AppCompatActivity implements OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pindaoguanli);
        //dTopTitle.setStatusBar(this,"#ffcc3131");
        initdata();
        initView();
    }

    private void initdata() {
        mImageView = (ImageView) findViewById(R.id.my_category_tip_fanhui);

        mImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PinDaoguanli.this, MainActivity.class);
    ...
    public void initView() {
        ...
        Cursor cursor = mDb.query("channel", new String[]{"name"}, "style=?", new String[]{"1"}, null, null, null);
        while (cursor.moveToNext()) {
            String string = cursor.getString(0);
            mUserList.add(string);
        }
        Cursor cursor2 = mDb.query("channel", new String[]{"name"}, "style=?", new String[]{"0"}, null, null, null);
        ...
        switch (parent.getId()) {
            case R.id.userGridView:
                ...
                if (position != 0 && position != 1 && flag) {
                    ...
                    if (moveImageView != null) {
                        ...
                        values.put("style", "0");
                        int i = mDb.update("channel", values, "name=?", new String[]{mUserList.get(position)});
            ...
            case R.id.otherGridView:
                ...
                if (moveImageView != null && flag) {
                    ...
                    ContentValues values = new ContentValues();
                    values.put("style", "1");
                    int i = mDb.update("channel", values, "name=?", new String[]{mOtherList.get(position)});
                    new Handler().postDelayed(new Runnable() {
                        public void run() {
                            try {
                                int[] endLocation = new int[2];
