 ...
 */
public class XUtils_utils {

    private volatile static XUtils_utils instance;

    //私有化构造器
    private XUtils_utils() {
    }

    /**
     * 单例模式
     */
    public static XUtils_utils getInstance() {
        if (instance == null) {
            synchronized (XUtils_utils.class) {
                if (instance == null) {
                    instance = new XUtils_utils();
                }
            }
        }
        return instance;
